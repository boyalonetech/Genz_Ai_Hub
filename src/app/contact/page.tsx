    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <div className="relative bg-white px-4 overflow-hidden lg:h-[60vh] sm:px-6 lg:px-8 py-12 md:py-16 lg:py-20">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h1 className="text-indigo-800 text-4xl sm:text-5xl md:text-6xl lg:text-6xl xl:text-7xl font-normal font-['Unbounded'] leading-tight mb-4 md:mb-6">
            Contact Us
          </h1>
          <p className="text-black text-base sm:text-medium xl:text-lg font-medium leading-relaxed tracking-tight max-w-2xl mx-auto">
