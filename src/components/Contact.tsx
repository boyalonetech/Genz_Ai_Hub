    ...
    <section className="w-full bg-zinc-100 py-12 md:py-20 px-4 md:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div>
          ...
          <h2 className="text-4xl md:text-4xl text-orange-500 mb-8">
            Contact Us
          </h2>
          ...
          <form className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-5 py-2.5 bg-zinc-300 rounded-lg text-[10px] outline-1 outline-neutral-400"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-5 py-2.5 bg-zinc-300 rounded-lg text-[10px] outline-1 outline-neutral-400 resize-none"
              ></textarea>
            </div>

            <button
              type="submit"
              className="w-full px-5 py-4 bg-orange-500 rounded-lg text-white text-[14px] font-medium hover:bg-orange-600 transition-colors"
            >
              Submit
            </button>
          </form>
