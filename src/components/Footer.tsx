...
export default function Footer() {
  return (
    <footer className="w-full bg-white py-12 md:py-16 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex gap-4">
            ...
            <Link href="/">
              <svg
                ...
                height={24}
                viewBox="0 0 24 24"
                className="w-8 h-8 text-indigo-800 rounded hover:text-orange-500 cursor-pointer transition-colors"
              >
                <path
                  fill="currentColor"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8 pb-8 border-b-2 border-indigo-800/50">
          {/* Pages */}
          <div>
            <h3 className="text-2xl md:text-2xl text-orange-500 mb-4">Pages</h3>
            <ul className="space-y-2">
              <li>
                <Link
                  href="/"
                  className="text-indigo-800 text-lg hover:text-orange-500 transition-colors"
                >
                  About
                </Link>
              </li>
          ...
          {/* Support */}
          <div>
            <h3 className="text-2xl md:text-2xl text-orange-500 mb-4">
              Support
            </h3>
            <ul className="space-y-2">
              <li>
          ...
          <div>
            ...
            <p className="text-lg md:text-lg text-black mb-4">
            ...
            <div className="flex gap-2 bg-zinc-300 rounded-lg p-1">
              <input
                ...
                className="flex-1 px-3 py-2 bg-transparent text-black/60 outline-none"
              />
              <button className="w-10 h-10 pr-5 bg-orange-500 rounded-lg flex items-center justify-center hover:bg-orange-600 transition-colors">
