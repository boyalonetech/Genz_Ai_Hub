...
export default function Roadmap() {
  return (
    <section className="w-full bg-white py-12 md:py-20 px-4 md:px-8 relative overflow-hidden">
      {/* Decorative Background Circles */}
      <div className="w-64 h-64 md:w-96 md:h-96 absolute -right-20 md:right-20 top-1/2 opacity-0 lg:opacity-75 bg-orange-500 rounded-full shadow-inner pointer-events-none" />
      <div className="w-48 h-48 md:w-64 md:h-64 absolute -left-10 md:left-0 top-0 opacity-0 lg:opacity-75 bg-orange-500 rounded-full shadow-inner pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-12 md:space-y-16">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="w-px h-16 bg-orange-500 mt-8" />
          </div>
