...
export default function Value() {
  return (
    <section className="w-full bg-white pb-12 pt-30 sm:pt-10 lg:pt-10 md:pb-20 px-4 md:px-8 ">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="p-8 rounded-lg outline-1 outline-orange-500 bg-white">
            <div className="w-12 h-12 bg-orange-400 rounded-full flex items-center justify-center mb-8">
