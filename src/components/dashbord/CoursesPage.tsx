  ...
  import { Course, CourseFormData, Module, Lesson } from '@/types/course';
  ...
  const CoursesPage: React.FC = () => {
    ...
    const addModule = () => {
      const newModule: Module = {
        ...
        description: '',
        lessons: [],
        order: courseForm.modules.length
      };
      setCourseForm({
        ...courseForm,
    ...
    // Array field helpers (for learning objectives and requirements)
    const handleArrayFieldChange = (field: 'learning_objectives' | 'requirements', value: string, index?: number) => {
    ...
    const removeArrayItem = (field: 'learning_objectives' | 'requirements', index: number) => {
      const currentArray = courseForm[field] || [];
      const newArray = currentArray.filter((_, i) => i !== index);
      setCourseForm({ ...courseForm, [field]: newArray });
    };

    // Helper function to safely calculate total lessons
    ...
    // Helper function to safely get module count
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                  <div className="flex justify-between items-center mb-4">
                    <label className="block text-sm font-medium text-gray-700">Course Modules & Lessons</label>
                    <button
                      type="button"
                      onClick={addModule}
                  ...
                  <div className="space-y-6">
                    {courseForm.modules?.map((module, moduleIndex) => (
                      <div key={moduleIndex} className="border border-gray-300 rounded-lg p-4">
                        <div className="flex justify-between items-start mb-4">
                          <h3 className="font-semibold text-gray-800">Module {moduleIndex + 1}</h3>
                          <button
                            type="button"
                            ...
                            {module.lessons?.map((lesson, lessonIndex) => (
                              <div key={lessonIndex} className="border border-gray-200 rounded-lg p-4">
                                <div className="flex justify-between items-start mb-3">
                                  <h5 className="font-medium text-gray-800">Lesson {lessonIndex + 1}</h5>
                                  <button
                                    type="button"
